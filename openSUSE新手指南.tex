...
\paragraph{软件源} 软件源就是软件下载的来源，默认有几个主源，如果主源里面没有想要的软件包而在软
...
\end{Verbatim}
上述选项都可以简化输入，对应关系为：\begin{inparaitem}
 \item \simp{update}{up}
...
\paragraph{\href{http://software.opensuse.org/packages}{软件包搜索}与一键安装} 在这里你可以搜索你想要的软件包。
...
Office：LibreOffice, WPS，安装好后需要下载安装\href{http://pan.baidu.com/s/1mgC3A0C}{Symbols}字
...
添加软件源的方法可以参见\href{https://zh.opensuse.org/SDB:%E6%B7%BB%E5%8A%A0%E8%BD%AF%E4%BB%B6%E6%BA%90}{SDB:添加软件源}
